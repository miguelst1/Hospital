/* Referencias:
  ...
  let colecciones = {
    altas: { dni: 'string', nombre: 'string', apellidos: 'string', fechaAlta: 'string' },
    bajas: { dni: 'string', nombre: 'string', apellidos: 'string', fechaBaja: 'string' }
};
...
let index = `
     <div style="margin: 50px">
         ...
         <ul style="padding-left: 50px">
           ...
           <li><b>Altas</b>: Permite realizar operaciones CRUD sobre los altas de la BD. </li>
           <li><b>Bajas</b>: Permite realizar operaciones CRUD sobre los bajas de la BD.</li>
         </ul>
     </div>`;
...
window.addEventListener('load', function () {
    ...
    let a = document.getElementById('altas');
    let c = document.getElementById('bajas');
    ...
    document.getElementById('menu-altas').addEventListener('click', function (e) {
        verDocumentos('altas');
    ...
    document.getElementById('menu-bajas').addEventListener('click', function (e) {
        verDocumentos('bajas');
